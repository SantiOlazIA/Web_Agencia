        ...
        <footer className="bg-secondary text-primary py-12 border-t border-primary/10">
            <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
                ...
                <div className="col-span-1 md:col-span-2 space-y-6">
                    <div className="font-serif font-light text-2xl tracking-widest text-primary lowercase">
                        {CLIENT.brandName}
                    </div>
                ...
                <div>
                    <h4 className="uppercase tracking-widest text-xs font-semibold mb-4 text-primary text-primary/40">Links</h4>
                ...
                <div>
                    <h4 className="uppercase tracking-widest text-xs font-semibold mb-4 text-primary text-primary/40">Contacto</h4>
                    <ul className="space-y-2 text-sm text-muted">
                        <li>
